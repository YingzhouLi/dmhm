...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::Multiply (y := H x + y)");
#endif
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::Multiply (y := H x)");
#endif
    y.Resize( Height() );
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::TransposeMultiply (y := H^T x + y)");
#endif
    hmat_tools::Scale( beta, y );
    switch( block_.type )
    {
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::TransposeMultiply (y := H^T x)");
#endif
    y.Resize( Width() );
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::AdjointMultiply (y := H^H x + y)");
#endif
    hmat_tools::Scale( beta, y );
    switch( block_.type )
    {
...
( Scalar alpha, Vector<Scalar>& x, Scalar beta, Vector<Scalar>& y ) const
{
    ...
    ("HMat3d::AdjointMultiply (y := H^H x + y, non-const)");
#endif
    hmat_tools::Scale( beta, y );
    switch( block_.type )
    {
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::AdjointMultiply (y := H^H x)");
#endif
    y.Resize( Width() );
...
{
#ifndef RELEASE
    CallStackEntry entry("HMat3d::AdjointMultiply (y := H^H x, non-const)");
#endif
    y.Resize( Width() );
    AdjointMultiply( alpha, x, 0, y );
}
