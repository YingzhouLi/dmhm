...
void
DistHMat2d<Scalar>::MultiplyHMatFHHPrecompute
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPrecompute");
#endif
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHSums
( Scalar alpha, DistHMat2d<Scalar>& B,
                DistHMat2d<Scalar>& C,
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHSums");
#endif
    DistHMat2d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHSumsCount
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHSumsCount");
#endif
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHSumsPack
( DistHMat2d<Scalar>& B,
  DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHSumsPack");
#endif
    DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHSumsUnpack
( DistHMat2d<Scalar>& B,
  DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHSumsUnpack");
#endif
    DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHPassData
( Scalar alpha, DistHMat2d<Scalar>& B,
                DistHMat2d<Scalar>& C,
  int startLevel, int endLevel, 
  int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPassData");
#endif
    DistHMat2d<Scalar>& A = *this;
...
template<typename Scalar>
void 
DistHMat2d<Scalar>::MultiplyHMatFHHPassDataCount
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPassDataCount");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void 
DistHMat2d<Scalar>::MultiplyHMatFHHPassDataPack
( DistHMat2d<Scalar>& B,
  DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPassDataPack");
#endif
    DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void 
DistHMat2d<Scalar>::MultiplyHMatFHHPassDataUnpack
( DistHMat2d<Scalar>& B,
  DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPassDataUnpack");
#endif
    DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHBroadcasts
( Scalar alpha, DistHMat2d<Scalar>& B,
                DistHMat2d<Scalar>& C,
  int startLevel, int endLevel,
  int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHBroadcasts");
#endif
    DistHMat2d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHBroadcastsCount
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
        std::vector<int>& sizes,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHBroadcastsCount");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHBroadcastsPack
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
  std::vector<Scalar>& buffer, std::vector<int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHBroadcastsPack");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHBroadcastsUnpack
( DistHMat2d<Scalar>& B,
  DistHMat2d<Scalar>& C,
  const std::vector<Scalar>& buffer, std::vector<int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHBroadcastsUnpack");
#endif
    DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHPostcompute
( Scalar alpha, DistHMat2d<Scalar>& B,
                DistHMat2d<Scalar>& C,
  int startLevel, int endLevel, 
  int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPostcompute");
#endif
    DistHMat2d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHPostcomputeC
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPostcomputeC");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHPostcomputeCCleanup
( int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHPostcomputeCCleanup");
#endif
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalize
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalize");
#endif
    const DistHMat2d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalizeCounts
( std::vector<int>& numQRs, 
  std::vector<int>& numTargetFHH, std::vector<int>& numSourceFHH,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalizeCounts");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalizeMiddleUpdates
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalizeMiddleUpdates");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalizeLocalQR
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalizeLocalQR");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalizeOuterUpdates
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
        std::vector<Scalar>& allReduceBuffer,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalizeOuterUpdates");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat2d<Scalar>::MultiplyHMatFHHFinalizeFormLowRank
( const DistHMat2d<Scalar>& B,
        DistHMat2d<Scalar>& C,
        std::vector<Scalar>& allReduceBuffer,
        std::vector<int>& leftOffsets,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat2d::MultiplyHMatFHHFinalizeFormLowRank");
#endif
    const DistHMat2d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
