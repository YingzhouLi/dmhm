...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorInitialize
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorInitialize");
#endif
    context.Clear();
    switch( block_.type )
    {
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorInitialize
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorInitialize");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorInitialize
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorInitialize");
#endif
    // The non-transposed initialization is identical
    MultiplyVectorInitialize( context );
}
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorPrecompute
( MultiplyVectorContext& context,
  Scalar alpha, const Vector<Scalar>& xLocal, Vector<Scalar>& yLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorPrecompute");
#endif
    if( !inSourceTeam_ )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorPrecompute
( MultiplyVectorContext& context,
  Scalar alpha, const Vector<Scalar>& xLocal, Vector<Scalar>& yLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorPrecompute");
#endif
    if( !inTargetTeam_ )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorPrecompute
( MultiplyVectorContext& context,
  Scalar alpha, const Vector<Scalar>& xLocal, Vector<Scalar>& yLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorPrecompute");
#endif
    if( !inTargetTeam_ )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorSums
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorSums
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorSums
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorSums");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorPassData
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorPassData");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorPassDataCount
( std::map<int,int>& sendSizes, std::map<int,int>& recvSizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorPassDataCount");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorPassData
( MultiplyVectorContext& context, const Vector<Scalar>& xLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorPassData");
#endif
    // Constuct maps of the send/recv processes to the send/recv sizes
    std::map<int,int> sendSizes, recvSizes;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorPassDataCount
( std::map<int,int>& sendSizes, std::map<int,int>& recvSizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorPassDataCount");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorPassData
( MultiplyVectorContext& context, const Vector<Scalar>& xLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorPassData");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyVectorBroadcasts
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorBroadcasts");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::TransposeMultiplyVectorBroadcasts
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorBroadcasts");
#endif
    // Compute the message sizes for each broadcast
    const int numLevels = teams_->NumLevels();
    const int numBroadcasts = numLevels-1;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorBroadcasts
( MultiplyVectorContext& context ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorBroadcasts");
#endif
    // The unconjugated version should be identical
    TransposeMultiplyVectorBroadcasts( context );
}
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyVectorPostcompute");
#endif
    if( !inTargetTeam_ )
        return;
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::TransposeMultiplyVectorPostcompute");
#endif
    if( !inSourceTeam_ )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointMultiplyVectorPostcompute
( MultiplyVectorContext& context,
  Scalar alpha, const Vector<Scalar>& xLocal,
                      Vector<Scalar>& yLocal ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointMultiplyVectorPostcompute");
#endif
    if( !inSourceTeam_ )
        return;
