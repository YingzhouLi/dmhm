...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressPrecompute()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressPrecompute");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesOmegaTUV()
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesOmegaTUV");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesOmegaTUVCount
( Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesOmegaTUVCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesOmegaTUVPack
( Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesOmegaTUVPack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressTreeReducesOmegaTUV
( Vector<Scalar>& buffer, Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressTreeReducesOmegaTUV");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesOmegaTUVUnpack
( const Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesOmegaTUVUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressPassOmegaTUV()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressPassOmegaTUV");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressPassOmegaTUVCount
( std::map<int,int>& sendsizes, std::map<int,int>& recvsizes )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressPassOmegaTUVCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressPassOmegaTUVPack
( Vector<Scalar>& buffer, std::map<int,int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressPassOmegaTUVPack");
#endif
    if(  Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressPassOmegaTUVUnpack
( const Vector<Scalar>& buffer, std::map<int,int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressPassOmegaTUVUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsOmegaTUV()
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressBroadcastsOmegaTUV");
#endif
    const int numLevels = teams_->NumLevels();
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsOmegaTUVCount
( Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressBroadcastsOmegaTUVCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsOmegaTUVPack
( Vector<Scalar>& buffer, Vector<int>& offsets ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressBroadcastsOmegaTUVPack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressTreeBroadcastsOmegaTUV
( Vector<Scalar>& buffer, Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressTreeBroadcastsOmegaTUV");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsOmegaTUVUnpack
( Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressBroadcastsOmegaTUVUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressMidcompute()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressMidcompute");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesTSqr()
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesTSqr");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesTSqrCount
( Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesTSqrCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesTSqrPack
( Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesTSqrPack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressTreeReducesTSqr
( Vector<Scalar>& buffer, Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressTreeReducesTSqr");
#endif
    teams_-> TreeSumToRoots( buffer, sizes );
}
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressReducesTSqrUnpack
( const Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry
        ("DistHMat3d::MultiplyHMatRandomCompressReducesTSqrUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsNum()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsNum");
#endif
    const int numLevels = teams_->NumLevels();
    const int numBroadcasts = numLevels-1;
    Vector<int> sizes( numBroadcasts, 0 );
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsNumCount
( Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsNumCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsNumPack
( Vector<int>& buffer, Vector<int>& offsets ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsNumPack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressTreeBroadcastsNum
( Vector<int>& buffer, Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressTreeBroadcastsNum");
#endif
    teams_-> TreeBroadcasts( buffer, sizes );
}
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsNumUnpack
( Vector<int>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsNumUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcasts()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcasts");
#endif
    const int numLevels = teams_->NumLevels();
    const int numBroadcasts = numLevels-1;
    Vector<int> sizes( numBroadcasts, 0 );
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsCount
( Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsPack
( Vector<Scalar>& buffer, Vector<int>& offsets ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsPack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressTreeBroadcasts
( Vector<Scalar>& buffer, Vector<int>& sizes ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressTreeBroadcasts");
#endif
    teams_-> TreeBroadcasts( buffer, sizes );
}
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressBroadcastsUnpack
( Vector<Scalar>& buffer, Vector<int>& offsets )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressBroadcastsUnpack");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatRandomCompressFinalcompute()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatRandomCompressFinalcompute");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
