...
void
DistHMat3d<Scalar>::MultiplyHMatMainSetUp
( const DistHMat3d<Scalar>& B,
        DistHMat3d<Scalar>& C ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSetUp");
#endif
    ...
    else if( C.numLevels_ > 1 ) // C is hierarchical
    {
        if( teamSize > 1 )
        {
            if( C.inSourceTeam_ || C.inTargetTeam_ )
            {
                ...
                for( int j=0; j<64; ++j )
                    node.children[j] = new DistHMat3d<Scalar>;
            }
            else
            {
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPrecompute
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPrecompute");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSums
( DistHMat3d<Scalar>& B, DistHMat3d<Scalar>& C,
  int startLevel, int endLevel,
  int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSums");
#endif
    DistHMat3d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsCountA
( Vector<int>& sizes, int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsCountA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsPackA
( Vector<Scalar>& buffer, Vector<int>& offsets, 
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsPackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsUnpackA
( const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsUnpackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsCountB
( Vector<int>& sizes, int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsCountB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsPackB
( Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsPackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsUnpackB
( const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsUnpackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsCountC
( const DistHMat3d<Scalar>& B,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsCountC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    const bool admissibleC = C.Admissible();
    switch( A.block_.type )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsPackC
( const DistHMat3d<Scalar>& B, 
        DistHMat3d<Scalar>& C,
  Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsPackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    const int key = A.sourceOffset_;
    const bool admissibleC = C.Admissible();
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainSumsUnpackC
( const DistHMat3d<Scalar>& B,
        DistHMat3d<Scalar>& C,
  const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainSumsUnpackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    const int key = A.sourceOffset_;
    const bool admissibleC = C.Admissible();
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassData
( Scalar alpha, DistHMat3d<Scalar>& B,
                DistHMat3d<Scalar>& C,
  int startLevel, int endLevel, int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassData");
#endif
    DistHMat3d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataCountA
( std::map<int,int>& sendSizes, std::map<int,int>& recvSizes,
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataCountA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataPackA
( Vector<Scalar>& sendBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel ) 
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataPackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataUnpackA
( const Vector<Scalar>& recvBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel ) 
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataUnpackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataCountB
( std::map<int,int>& sendSizes, std::map<int,int>& recvSizes,
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataCountB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataPackB
( Vector<Scalar>& sendBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataPackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataUnpackB
( const Vector<Scalar>& recvBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataUnpackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataCountC
( const DistHMat3d<Scalar>& B,
  const DistHMat3d<Scalar>& C,
  std::map<int,int>& sendSizes, std::map<int,int>& recvSizes,
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataCountC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataPackC
( const DistHMat3d<Scalar>& B,
        DistHMat3d<Scalar>& C,
  Vector<Scalar>& sendBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataPackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPassDataUnpackC
( const DistHMat3d<Scalar>& B,
        DistHMat3d<Scalar>& C,
  const Vector<Scalar>& recvBuffer, std::map<int,int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPassDataUnpackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcasts
( DistHMat3d<Scalar>& B,
  DistHMat3d<Scalar>& C, 
  int startLevel, int endLevel, int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcasts");
#endif
    DistHMat3d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsCountA
( Vector<int>& sizes, int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsCountA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsPackA
( Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsPackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsUnpackA
( const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsUnpackA");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsCountB
( Vector<int>& sizes, int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsCountB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsPackB
( Vector<Scalar>& buffer, Vector<int>& offsets, 
  int startLevel, int endLevel ) const
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsPackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsUnpackB
( const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsUnpackB");
#endif
    switch( block_.type )
    {
    case DIST_NODE:
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsCountC
( const DistHMat3d<Scalar>& B,
  const DistHMat3d<Scalar>& C, 
  Vector<int>& sizes, 
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsCountC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsPackC
( const DistHMat3d<Scalar>& B, 
        DistHMat3d<Scalar>& C,
  Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel,
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsPackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainBroadcastsUnpackC
( const DistHMat3d<Scalar>& B,
        DistHMat3d<Scalar>& C,
  const Vector<Scalar>& buffer, Vector<int>& offsets,
  int startLevel, int endLevel, 
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainBroadcastsUnpackC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPostcompute
( Scalar alpha, DistHMat3d<Scalar>& B,
                DistHMat3d<Scalar>& C,
  int startLevel, int endLevel, int startUpdate, int endUpdate )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPostcompute");
#endif
    DistHMat3d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPostcomputeA
( int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPostcomputeA");
#endif
    DistHMat3d<Scalar>& A = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPostcomputeB
( int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPostcomputeB");
#endif
    DistHMat3d<Scalar>& B = *this;
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPostcomputeC
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPostcomputeC");
#endif
    const DistHMat3d<Scalar>& A = *this;
    if( (!A.inTargetTeam_ && !A.inSourceTeam_ && !B.inSourceTeam_) ||
        A.Height() == 0 || A.Width() == 0 || B.Width() == 0 )
...
template<typename Scalar>
void
DistHMat3d<Scalar>::MultiplyHMatMainPostcomputeCCleanup
( int startLevel, int endLevel )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::MultiplyHMatMainPostcomputeCCleanup");
#endif
