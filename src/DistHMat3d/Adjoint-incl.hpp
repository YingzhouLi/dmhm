...
void
DistHMat3d<Scalar>::Adjoint()
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::Adjoint");
#endif
    // This requires communication and is not yet written
    throw std::logic_error("DistHMat3d::Adjoint is not yet written");
}

template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointFrom( const DistHMat3d<Scalar>& B )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointFrom");
#endif
    AdjointCopy( B );
    AdjointPassData( B );
}
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointCopy( const DistHMat3d<Scalar>& B )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointCopy");
#endif
...
template<typename Scalar>
void
DistHMat3d<Scalar>::AdjointPassData( const DistHMat3d<Scalar>& B )
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointPassData");
#endif
...
{
#ifndef RELEASE
    CallStackEntry entry("DistHMat3d::AdjointPassDataCount");
#endif
    if( Height() == 0 || Width() == 0 )
        return;
