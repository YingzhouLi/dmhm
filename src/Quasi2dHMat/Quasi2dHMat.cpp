...
void 
dmhm::Quasi2dHMat<Scalar,Conjugated>::BuildMapOnQuadrant
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::BuildNaturalToHierarchicalMap
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::Clear()
{
    _block.Clear();
}
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::Print( const std::string tag ) const
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::LatexWriteStructure
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::MScriptWriteStructure
( const std::string filebase ) const
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::CopyFrom
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::Conjugate()
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::ConjugateFrom
( const Quasi2dHMat<Scalar,Conjugated>& B )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::TransposeFrom
( const Quasi2dHMat<Scalar,Conjugated>& B )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::AdjointFrom
( const Quasi2dHMat<Scalar,Conjugated>& B )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::Scale( Scalar alpha )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::SetToIdentity()
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::AddConstantToDiagonal
( Scalar alpha )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::UpdateWith
...
template<typename Scalar,bool Conjugated>
bool
dmhm::Quasi2dHMat<Scalar,Conjugated>::Admissible() const
{
...
template<typename Scalar,bool Conjugated>
bool
dmhm::Quasi2dHMat<Scalar,Conjugated>::Admissible
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::ImportLowRank
( const LowRank<Scalar,Conjugated>& F )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::UpdateWithLowRank
( Scalar alpha, 
  const LowRank<Scalar,Conjugated>& F )
{
#ifndef RELEASE
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::ImportSparse
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::UpdateVectorWithNodeSymmetric
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::UpdateWithNodeSymmetric
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::LatexWriteStructureRecursion
...
template<typename Scalar,bool Conjugated>
void
dmhm::Quasi2dHMat<Scalar,Conjugated>::MScriptWriteStructureRecursion
...
template class dmhm::Quasi2dHMat<float,false>;
template class dmhm::Quasi2dHMat<float,true>;
template class dmhm::Quasi2dHMat<double,false>;
template class dmhm::Quasi2dHMat<double,true>;
template class dmhm::Quasi2dHMat<std::complex<float>,false>;
template class dmhm::Quasi2dHMat<std::complex<float>,true>;
template class dmhm::Quasi2dHMat<std::complex<double>,false>;
template class dmhm::Quasi2dHMat<std::complex<double>,true>;
