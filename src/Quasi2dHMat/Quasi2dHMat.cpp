...
void 
Quasi2dHMat<Scalar>::BuildMapOnQuadrant
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::BuildNaturalToHierarchicalMap
...
template<typename Scalar>
Quasi2dHMat<Scalar>::Quasi2dHMat()
: _numLevels(0),
  _maxRank(0),
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::Clear()
{ _block.Clear(); }

template<typename Scalar>
void
Quasi2dHMat<Scalar>::Print( const std::string tag ) const
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::LatexWriteStructure( const std::string filebase ) const
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::MScriptWriteStructure( const std::string filebase ) const
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::CopyFrom( const Quasi2dHMat<Scalar>& B )
{
#ifndef RELEASE
    ...
    case NODE:
    {
        ...
        for( int i=0; i<16; ++i )
        {
            nodeA.children[i] = new Quasi2dHMat<Scalar>;
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::ConjugateFrom( const Quasi2dHMat<Scalar>& B )
{
#ifndef RELEASE
    PushCallStack("Quasi2dHMat::ConjugateFrom");
#endif
    Quasi2dHMat<Scalar>& A = *this;
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::TransposeFrom( const Quasi2dHMat<Scalar>& B )
{
#ifndef RELEASE
    ...
    case NODE:
    {
        ...
        for( int t=0; t<4; ++t )
        {
            for( int s=0; s<4; ++s )
            {
                nodeA.children[s+4*t] = new Quasi2dHMat<Scalar>;
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::AdjointFrom( const Quasi2dHMat<Scalar>& B )
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::Scale( Scalar alpha )
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::SetToIdentity()
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::AddConstantToDiagonal( Scalar alpha )
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::UpdateWith( Scalar alpha, const Quasi2dHMat<Scalar>& B )
{
#ifndef RELEASE
...
template<typename Scalar>
bool
Quasi2dHMat<Scalar>::Admissible() const
{
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::ImportLowRank( const LowRank<Scalar>& F )
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::UpdateWithLowRank( Scalar alpha, const LowRank<Scalar>& F )
{
#ifndef RELEASE
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::ImportSparse
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::UpdateVectorWithNodeSymmetric
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::UpdateWithNodeSymmetric
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::LatexWriteStructureRecursion
...
template<typename Scalar>
void
Quasi2dHMat<Scalar>::MScriptWriteStructureRecursion( std::ofstream& file ) const
{
    switch( _block.type )
    {
    case NODE:
...
template class Quasi2dHMat<float>;
template class Quasi2dHMat<double>;
template class Quasi2dHMat<std::complex<float> >;
template class Quasi2dHMat<std::complex<double> >;
